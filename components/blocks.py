...
class Door(pygame.sprite.Sprite):
    def __init__(self, x: int, y: int, rotate: bool = False) -> None:
        ...
        self.image = load_image(os.path.join("GAME", "blocks", "2.png")).convert_alpha()
...
class Wall(Block):
    def __init__(self, x: int, y: int) -> None:
        self.image = load_image(os.path.join("GAME", "blocks", "1.png")).convert()
...
class Grass(Block):
    def __init__(self, x: int, y: int) -> None:
        self.image = load_image(os.path.join("GAME", "blocks", "0.png")).convert()
...
class Portal(pygame.sprite.Sprite):
    def __init__(self, x: int, y: int, func) -> None:
        super().__init__()
        self.normal_image = load_image(os.path.join("GAME", "portal", "image.png")).convert_alpha()
        self.selected_image = load_image(os.path.join("GAME", "portal", "selected.png")).convert_alpha()
